...
from scripts.improve_description import improve_description, IMPROVE_MODEL
from scripts.run_eval import find_project_root, run_eval, EVAL_MODEL
...
def main():
    ...
    parser.add_argument(
        ...
        help=f"Model for improvement (default: {IMPROVE_MODEL})",
    )
    parser.add_argument(
