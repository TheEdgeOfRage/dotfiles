...
**Description optimization**: This section requires the `opencode` CLI tool (specifically `opencode run`) which is only available in opencode environments. Skip it if you're on Claude.ai.
